...
<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#type_id').blur(function(){
				var id = $(this).val();
				$.post(
							"${pageContext.request.contextPath}/selectTypeById.do",
							{"type_id":id},
							function(data){
...
<div id="welcome" class="content" align="center" style="display:block;">
 			<table border="1"  >
	   <form action="upload.do?id=0" method="post" enctype="multipart/form-data">
                    <tr>
                        <td><label for="file">上传文件：</label></td>
                        <td><input type="file" id="file" name="book_img" value=""/></td>
                    </tr>
                    <tr>
      ...
      <div width="100"  height="100">
               <img alt="" src="${book_img}" width="70"  height="70"/>
      </div>          
<form action="addBook.do" method="post" enctype="multipart/form-data">
	<table align="center" border="1">
		<h1 align="center">添加图书</h1>
		<tr><td>book_name</td><td><input type="text" name="book_name" autofocus/></td></tr>
		<tr><td>book_writer</td><td><input type="text" name="book_writer" /></td></tr>
		<tr><td>book_publisher</td><td><input type="text" name="book_publisher" /></td></tr>
		<tr><td>book_publish_data</td><td><input type="text" name="book_publish_data" /></td></tr>
		<tr><td>type_id</td><td><input type="text" name="bookType.type_id" id="type_id" /><font id="isresult" ></font></td></tr>
		
		<tr><td>book_price</td><td><input type="text" name="book_price" /></td></tr>
		<tr><td>book_img</td><td><input type="text" name="book_img" value="${book_img}"/></td></tr>
