...
<div id="welcome" class="content" align="center" style="display:block;">    
	...
	<table align="center" border="1">
		...
		<tr><td>book_name</td><td><input type="text" name="book_name" value="${book.book_name}" readonly/></td></tr>
		<tr><td>book_writer</td><td><input type="text" name="book_writer" value="${book.book_writer}" readonly/></td></tr>
		<tr><td>book_publisher</td><td><input type="text" name="book_publisher" value="${book.book_publisher}" readonly/></td></tr>
		<tr><td>book_publish_data</td><td><input type="text" name="book_publish_data" value="${book.book_publish_data}" readonly/></td></tr>
		<tr><td>type_id</td><td><input type="text" name="type_id" value="${book.bookType.type_id}" readonly/></td></tr>
		<tr><td>type_name</td><td><input type="text" name="type_name" value="${book.bookType.type_name}" readonly/></td></tr>
	  	<tr><td>book_price</td><td><input type="text" name="book_price"  value="${book.book_price}" readonly/></td></tr>
		<tr><td>book_img</td><td> <img alt="图书图片" src="${book.book_img}" width="100"  height="100" /></td></tr>
	</table>
<a href="selectAllBook.do?id=3&result=1">返回图书列表</a>&nbsp;&nbsp;&nbsp;<a href="addBook.jsp">继续添加图书</a>
