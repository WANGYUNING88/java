...
<div id="welcome" class="content" style="display:block;">
  ...
  <input type="text" name="keyword" placeholder="请输入搜索关键字"/><input type="submit" value="搜索"/>
   </form> <p>  <font color="red">
			${errorMsg}
			</font> </p>
	...
	<tr>
		...
		<td>${book.bookType.getType_id()}</td>
		<td>${book.bookType.getType_name()}</td>
		<td>${book.book_price}</td>
		<td> <img alt="${book.book_img}" src="${book.book_img}" width="100"  height="100"/></td>
		<td><a href="selectBook.do?book_id=${book.book_id}">修改</a>||
		<a href="deleteBook.do?book_id=${book.book_id}">删除</a></td>
	</tr>
	</c:forEach>
	</table>
    <p> </p>
