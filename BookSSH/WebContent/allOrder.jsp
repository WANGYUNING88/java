...
<table border="1" align="center" border="1" >
	...
	<tr>
		...
		<td><a href="selectOrderDetailById.do?order_id=${o.order_id}">详情</a>||
			<a href="deleteOrder.do?id=1&order_id=${o.order_id}">删除</a>
		</td>
	</tr>
	</c:forEach>
	</table>
	<div align="center">
    <c:if test="${id!=null}"><a href="selectAllUser.do">返回用户管理</a></c:if>
    </div>
    </div>
</div>
