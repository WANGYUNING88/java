...
<div id="main"> 
<div id="leftMenu">
<ul><li><a href="addType.jsp">添加图书类型</a></li>												<!-- 5 --></ul>
</div>
<div id="content">
<div id="welcome" class="content" style="display:block;">
  <div align="center">
	...
	<h1 align="center">图书类型</h1>
		...
		<tr>
			<td>${BookType.type_id}</td>
			<td>${BookType.type_name}</td>
			<td><a href="selectTypeById.do?id=1&type_id=${BookType.type_id}">修改</a>||
			<a href="deleteType.do?type_id=${BookType.type_id}">删除</a></td>
		</tr>
			</c:forEach>		
	</table>
    <p> </p>
