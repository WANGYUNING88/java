...
<div id="welcome" class="content" style="display:block;">
  <div align="center">
    <p> </p>
  <h1 align="center" >修改图书类型</h1>
	<form action="updateType.do" method="post" >
	<table align="center" border="1" >
		<tr><td>type_id</td><td><input type="text" readonly="readonly" name="type_id" value="${booktype.type_id}"/></td></tr>
		<tr><td>type_name</td><td>
		<input type="text" name="type_name" id="type_name" value="${booktype.type_name}"/>
		<font id="isresult" ></font></td></tr>
